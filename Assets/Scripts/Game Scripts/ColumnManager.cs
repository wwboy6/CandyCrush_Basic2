...
public class ColumnManager : MonoBehaviour 
{
	...
	public static int[][] debug_colorMap = new int[][] {
		new int[] {1, 4, 2, 1, 3, 4, 5, 0, 1},
		new int[] {0, 2, 1, 0, 1, 2, 3, 4, 5},
		new int[] {0, 1, 0, 1, 0, 1, 2, 3, 4},
		new int[] {3, 4, 5, 1, 3, 4, 5, 0, 1},
		new int[] {3, 1, 3, 2, 2, 3, 4, 5, 0},
		new int[] {1, 0, 0, 3, 5, 0, 1, 2, 3},
		new int[] {5, 4, 5, 1, 3, 3, 5, 5, 1},
		new int[] {4, 3, 1, 2, 5, 1, 2, 3, 4},
		new int[] {5, 4, 5, 5, 3, 5, 5, 0, 1}
	};
